...
class Wallet(object):
    ...
    def info(self, detail=3):
        ...
        balance_network = balances[0]['network']
        balance_num = str(Value.from_satoshi(balances[0]['balance'], network=balances[0]['network']).str_unit(currency_repr='symbol'))
        return (balance_network, balance_num)
